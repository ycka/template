    ...
    <div class="login-container">
        <el-form autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left"
            ...
            <el-form-item prop="user">
                ...
                <el-input name="user" type="text" v-model="loginForm.user" autoComplete="off"
                          placeholder="登录用户"></el-input>
            </el-form-item>
    ...
    export default {
      ...
      created() {
        ...
        // window.addEventListener('hashchange', this.afterQRScan);
            this.$axios.fetch('/api/user',{a:1,b:2}).then((res)=>{
                console.log('axios');
                console.log(res)
            }).then((res)=>{
                console.log('err '+ res)
            ...
            Vue.http.post('/api/user',{a:1,b:9}).then((response) => {
                // 响应成功回调
                //console.log('成功回调')
